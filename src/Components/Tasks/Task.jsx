...
export default function Task() {
  ...
  const fetchTasks = async () => {
    try {
      ...
      toast.error(error.response ? error.response.data.message : "Error fetching tasks");
    }
  };
  ...
  const handleAddTask = async () => {
    ...
    try {
      ...
      setNewTask({ title: "", category: "", priority: "medium", status: "incomplete" });
      setIsModalOpen(false);
      toast.success("Task added successfully");
    } catch (error) {
      console.error("Error adding task:", error);
      toast.error(error.response ? error.response.data.message : "Error adding task");
    }
  };
  ...
  const handleSaveEdit = async () => {
    if (!editingTask.title.trim()) return toast.error("Task title is required!");
  ...
  const handleDeleteTask = async (task_id) => {
    try {
      ...
      toast.error(error.response ? error.response.data.message : "Error deleting task");
    }
  };
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-11/12 max-w-md">
            ...
            <div className="flex justify-end gap-2">
              ...
              <button onClick={handleAddTask} className="px-4 py-2 bg-blue-500 text-white rounded-lg">
                Add Task
              </button>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-11/12 max-w-md">
            ...
            <div className="flex justify-end gap-2">
              ...
              <button onClick={handleSaveEdit} className="px-4 py-2 bg-blue-500 text-white rounded-lg">
                Save
              </button>
            </div>
          </div>
